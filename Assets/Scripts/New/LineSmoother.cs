...
public static class LineSmoother
{
    ...
    /// </summary>
    /// <param name="inputPoints">input polyline points</param>
    /// <param name="segmentSize">length of each segment of the output polyline</param>
    /// <returns>Approximated curve points.</returns>
